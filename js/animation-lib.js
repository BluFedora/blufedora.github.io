...
var blufedora_Main = function() { };
blufedora_Main.__name__ = true;
blufedora_Main.main = function() {
	var $window = window;
	$window.addEventListener("load",blufedora_Main.onLoad);
};
blufedora_Main.onLoad = function() {
	...
	if(portfolio_container != null) {
		var callback = function(json_text) {
			...
			while(_g < items.length) {
				...
				element.addEventListener("click",blufedora_Main.onPortfolioItemClicked);
...
blufedora_Main.onPortfolioItemClicked = function(evt) {
